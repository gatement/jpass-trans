...
# tproxy
iptables -t mangle -A PREROUTING -p udp -j TPROXY --on-port 8116 --tproxy-mark 1
iptables -t mangle -A PREROUTING -p tcp -j TPROXY --on-port 8117 --tproxy-mark 0x2333/0x2333 
